...
description: "Every tool the Agentix MCP server exposes, grouped by resource, with the REST endpoint it maps to."
---
...
<Note>
  ...
  client to "list available Agentix tools." The catalog below is the stable set grouped by resource.
</Note>
