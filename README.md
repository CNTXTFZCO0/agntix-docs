# Agntix Developer Portal

Public-facing documentation for the Agntix API. Built with [Mintlify](https://mintlify.com).
...
| `pnpm sync:openapi`  | Fetch `${GATEWAY_BASE_URL}/docs/json`, run the allowlist + denylist filter, and write `openapi/agntix.json` |
...
2. **Never** edit `openapi/agntix.json` by hand — re-run `pnpm sync:openapi`.
