---
title: "Event types"
description: "Reference for every webhook event Agntix can deliver, with payload schemas and example bodies."
---
...
Fired when a session is **initiated** — for outbound voice calls, this is _before pickup_. Use it to lock the originating task as "in-flight".
